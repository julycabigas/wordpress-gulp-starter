...
(_gsScope._gsQueue || (_gsScope._gsQueue = [])).push(function () {
  ...
  var t = document.documentElement,
    ...
    var s = "x" === r ? "Width" : "Height",
        ...
        a = "client" + s,
        o = document.body;
    return _i === e || _i === t || _i === o ? Math.max(t[n], o[n]) - (e["inner" + s] || Math.max(t[a], o[a])) : _i[n] - _i["offset" + s];
  },
      r = _gsScope._gsDefine.plugin({
    propName: "scrollTo",
    API: 2,
    version: "1.7.4",
    init: function init(t, r, s) {
      return this._wdw = t === e, this._target = t, this._tween = s, "object" != _typeof(r) && (r = {
        y: r
  ...
  _gsScope._gsDefine("plugins.CSSPlugin", ["plugins.TweenPlugin", "TweenLite"], function (t, e) {
    ...
    var u,
      ...
      var i,
          r,
          s = {};
      if (e = e || Q(t, null)) for (i in e) {
        (-1 === i.indexOf("Transform") || we === i) && (s[i] = e[i]);
      } else if (e = t.currentStyle || t.style) for (i in e) {
      ...
      for (a in i) {
        "cssText" !== a && "length" !== a && isNaN(a) && (e[a] !== (n = i[a]) || s && s[a]) && -1 === a.indexOf("Origin") && ("number" == typeof n || "string" == typeof n) && (l[a] = "auto" !== n || "left" !== a && "top" !== a ? "" !== n && "auto" !== n && "none" !== n || "string" != typeof e[a] || "" === e[a].replace(y, "") ? n : 0 : $(t, a), void 0 !== h[a] && (o = new _e(h, a, h[a], o)));
      }
      ...
      for (i = i || Q(t, null); --n > -1;) {
        r -= parseFloat(G(t, "padding" + s[n], i, !0)) || 0, r -= parseFloat(G(t, "border" + s[n] + "Width", i, !0)) || 0;
      }
    ...
    var fe = function fe(t, e, i, r) {
      ...
      return u ? s = e ? function (t) {
        ...
        if ("number" == typeof t) t += f;else if (r && M.test(t)) {
          for (c = t.replace(M, "|").split("|"), _ = 0; c.length > _; _++) {
            c[_] = s(c[_]);
          }

          return c.join(",");
        }
        if (e = (t.match(ue) || [n])[0], p = t.split(e).join("").match(v) || [], _ = p.length, u > _--) for (; u > ++_;) {
          p[_] = i ? p[0 | (_ - 1) / 2] : a[_];
        }
        ...
        if (e = t.match(v) || [], p = e.length, u > p--) for (; u > ++p;) {
          e[p] = i ? e[0 | (p - 1) / 2] : a[p];
        }
        return o + e.join(h) + l;
      } : function (t) {
      ...
      for (i._transform = null, z = e, r = u = i.parse(t, e, r, s), z = d, n && (i._transform = c, f && (f._prev = null, f._prev && (f._prev._next = null))); r && r !== f;) {
        if (1 >= r.type && (o = r.p, _[o] = r.s + r.c, p[o] = r.s, n || (h = new _e(r, "s", o, h, r.r), r.c = 0), 1 === r.type)) for (a = r.l; --a > 0;) {
          l = "xn" + a, o = r.p + "_" + l, _[o] = r.data[l], p[o] = r[l], n || (h = new _e(r, l, o, h, r.rxp[l]));
        }
        r = r._next;
      }
    ...
    for (h = ce.prototype, h.l = h.pr = 0; --me > 0;) {
      h["xn" + me] = 0, h["xs" + me] = "";
    }
    ...
    var ge = function ge(t, e) {
      ...
      for (i = i || [a], r = 0; n.length > r; r++) {
        e.prefix = 0 === r && e.prefix, e.defaultValue = i[r] || a, s = new ge(n[r], e);
      }
    },
        ye = function ye(t) {
      if (!l[t]) {
    ...
    var xe,
        ...
        we = H("transform"),
        be = V + "transform",
        Pe = H("transformOrigin"),
        Se = null !== H("perspective"),
      ...
      return X.createElementNS && !r && (t = ke("svg", Oe), e = ke("rect", t, {
        ...
        height: 50,
        x: 100
      }), i = e.getBoundingClientRect().width, e.style[Pe] = "50% 50%", e.style[we] = "scaleX(0.5)", r = i === e.getBoundingClientRect().width && !(_ && Se), Oe.removeChild(t)), r;
    }(),
        De = function De(t, e, i) {
      var r = t.getBBox();
      ...
      var n,
          ...
          v = 2e-5,
          y = 1e5,
          x = Se ? parseFloat(G(t, Pe, e, !1, "0 0 0").split(" ")[2]) || m.zOrigin || 0 : 0,
      ...
      if (we ? o = G(t, be, e, !0) : t.currentStyle && (o = t.currentStyle.filter.match(A), o = o && 4 === o.length ? [o[0].substr(4), Number(o[2].substr(4)), Number(o[1].substr(4)), o[3].substr(4), m.x || 0, m.y || 0].join(",") : ""), n = !o || "none" === o || "matrix(1, 0, 0, 1, 0, 0)" === o, m.svg = !!(Re && "function" == typeof t.getBBox && t.getCTM && (!t.parentNode || t.parentNode.getBBox && t.parentNode.getCTM)), m.svg && (De(t, G(t, Pe, s, !1, "50% 50%") + "", m), xe = a.useSVGTransformAttr || Ae, l = t.getAttribute("transform"), n && l && -1 !== l.indexOf("matrix") && (o = l, n = 0)), !n) {
        for (l = (o || "").match(/(?:\-|\b)[\d\-\.e]+\b/gi) || [], h = l.length; --h > -1;) {
          u = Number(l[h]), l[h] = (f = u - (u |= 0)) ? (0 | f * y + (0 > f ? -.5 : .5)) / y + u : u;
        }
      ...
      if (p) {
        ...
        if (null != r.ox && (_ = (r.oxp ? .01 * m * r.ox : r.ox) - m / 2, c = (r.oyp ? .01 * g * r.oy : r.oy) - g / 2, w += _ - (_ * o + c * l), b += c - (_ * h + c * u)), v ? (_ = m / 2, c = g / 2, y += ", Dx=" + (_ - (_ * o + c * l) + w) + ", Dy=" + (c - (_ * h + c * u) + b) + ")") : y += ", sizingMethod='auto expand')", f.filter = -1 !== e.indexOf("DXImageTransform.Microsoft.Matrix(") ? e.replace(D, y) : y + " " + e, (0 === t || 1 === t) && 1 === o && 0 === l && 0 === h && 1 === u && (v && -1 === y.indexOf("Dx=0, Dy=0") || T.test(e) && 100 !== parseFloat(RegExp.$1) || -1 === e.indexOf("gradient(" && e.indexOf("Alpha")) && f.removeAttribute("filter")), !v) {
          ...
          for (_ = r.ieOffsetX || 0, c = r.ieOffsetY || 0, r.ieOffsetX = Math.round((m - ((0 > o ? -o : o) * m + (0 > l ? -l : l) * g)) / 2 + w), r.ieOffsetY = Math.round((g - ((0 > u ? -u : u) * g + (0 > h ? -h : h) * m)) / 2 + b), me = 0; 4 > me; me++) {
            S = ee[me], P = p[S], i = -1 !== P.indexOf("px") ? parseFloat(P) : Z(this.t, S, parseFloat(P), P.replace(x, "")) || 0, C = i !== r[S] ? 2 > me ? -r.ieOffsetX : -r.ieOffsetY : 2 > me ? _ - r.ieOffsetX : c - r.ieOffsetY, f[S] = (r[S] = Math.round(i - C * (0 === me || 2 === me ? 1 : R))) + "px";
          }
        }
      }
    },
      ...
      var e,
          ...
          D = b.z,
          M = b.perspective;
      if (!(1 !== t && 0 !== t && b.force3D || b.force3D === !0 || b.rotationY || b.rotationX || 1 !== k || M || D)) return ze.call(this, t), void 0;
      if (_ && (d = 1e-4, d > C && C > -d && (C = k = 2e-5), d > R && R > -d && (R = k = 2e-5), !M || b.z || b.rotationX || b.rotationY || (M = 0)), S || b.skewX) m = e = Math.cos(S), g = s = Math.sin(S), b.skewX && (S -= b.skewX * L, m = Math.cos(S), g = Math.sin(S), "simple" === b.skewType && (v = Math.tan(b.skewX * L), v = Math.sqrt(1 + v * v), m *= v, g *= v)), i = -g, n = m;else {
        if (!(b.rotationY || b.rotationX || 1 !== k || M || b.svg)) return P[we] = (b.xPercent || b.yPercent ? "translate(" + b.xPercent + "%," + b.yPercent + "%) translate3d(" : "translate3d(") + O + "px," + A + "px," + D + "px)" + (1 !== C || 1 !== R ? " scale(" + C + "," + R + ")" : ""), void 0;
        e = n = 1, i = s = 0;
      }
      h = 1, r = a = o = l = u = f = 0, p = M ? -1 / M : 0, c = b.zOrigin, d = 1e-6, T = ",", w = "0", S = b.rotationY * L, S && (m = Math.cos(S), g = Math.sin(S), o = -g, u = p * -g, r = e * g, a = s * g, h = m, p *= m, e *= m, s *= m), S = b.rotationX * L, S && (m = Math.cos(S), g = Math.sin(S), v = i * m + r * g, y = n * m + a * g, l = h * g, f = p * g, r = i * -g + r * m, a = n * -g + a * m, h *= m, p *= m, i = v, n = y), 1 !== k && (r *= k, a *= k, h *= k, p *= k), 1 !== R && (i *= R, n *= R, l *= R, f *= R), 1 !== C && (e *= C, s *= C, o *= C, u *= C), (c || b.svg) && (c && (O += r * -c, A += a * -c, D += h * -c + c), b.svg && (O += b.xOrigin - (b.xOrigin * e + b.yOrigin * i), A += b.yOrigin - (b.xOrigin * s + b.yOrigin * n)), d > O && O > -d && (O = w), d > A && A > -d && (A = w), d > D && D > -d && (D = 0)), x = b.xPercent || b.yPercent ? "translate(" + b.xPercent + "%," + b.yPercent + "%) matrix3d(" : "matrix3d(", x += (d > e && e > -d ? w : e) + T + (d > s && s > -d ? w : s) + T + (d > o && o > -d ? w : o), x += T + (d > u && u > -d ? w : u) + T + (d > i && i > -d ? w : i) + T + (d > n && n > -d ? w : n), b.rotationX || b.rotationY ? (x += T + (d > l && l > -d ? w : l) + T + (d > f && f > -d ? w : f) + T + (d > r && r > -d ? w : r), x += T + (d > a && a > -d ? w : a) + T + (d > h && h > -d ? w : h) + T + (d > p && p > -d ? w : p) + T) : x += ",0,0,0,0,1,0,", x += O + T + A + T + D + T + (M ? 1 + -D / M : 1) + ")", P[we] = x;
    },
    ...
    h = Ce.prototype, h.x = h.y = h.z = h.skewX = h.skewY = h.rotation = h.rotationX = h.rotationY = h.zOrigin = h.xPercent = h.yPercent = 0, h.scaleX = h.scaleY = h.scaleZ = 1, ve("transform,scale,scaleX,scaleY,scaleZ,x,y,z,rotation,rotationX,rotationY,rotationZ,skewX,skewY,shortRotation,shortRotationX,shortRotationY,shortRotationZ,transformOrigin,transformPerspective,directionalRotation,parseTransform,force3D,skewType,xPercent,yPercent", {
      parser: function parser(t, e, i, r, n, o, l) {
        ...
        if ("string" == typeof x.transform && we) f = F.style, f[we] = x.transform, f.display = "block", f.position = "absolute", X.body.appendChild(F), h = Me(F, null, !1), X.body.removeChild(F);else if ("object" == _typeof(x)) {
          if (h = {
        ...
        for (Se && null != x.force3D && (m.force3D = x.force3D, c = !0), m.skewType = x.skewType || m.skewType || a.defaultSkewType, _ = m.force3D || m.z || m.rotationX || m.rotationY || h.z || h.rotationX || h.rotationY || h.perspective, _ || null == x.scale || (h.scaleZ = 1); --y > -1;) {
          i = Te[y], p = h[i] - m[i], (p > v || -v > p || null != x[i] || null != z[i]) && (c = !0, n = new ce(m, i, m[i], p, n), i in T && (n.e = T[i]), n.xs0 = 0, n.plugin = o, r._overwriteProps.push(n.n));
        }
      ...
      parser: function parser(t, e, i, r, n, a) {
        ...
        if (-1 !== m.indexOf("%") != (-1 !== g.indexOf("%")) && (p = G(t, "backgroundImage").replace(R, ""), p && "none" !== p)) {
          for (o = m.split(" "), l = g.split(" "), E.setAttribute("src", p), h = 2; --h > -1;) {
            m = o[h], u = -1 !== m.indexOf("%"), u !== (-1 !== l[h].indexOf("%")) && (f = 0 === h ? t.offsetWidth - E.width : t.offsetHeight - E.height, o[h] = u ? parseFloat(m) / 100 * f + "px" : 100 * (parseFloat(m) / f) + "%");
          }
    ...
    var Ie = function Ie(t, e) {
      ...
      if (this.t._gsClassPT = this, 1 === t || 0 === t) {
        ...
        for (var e = this.data, i = this.t.style; e;) {
          e.v ? i[e.p] = e.v : Ie(i, e.p), e = e._next;
        }
    ...
    var Ee = function Ee(t) {
      if ((1 === t || 0 === t) && this.data._totalTime === this.data._totalDuration && "isFromStart" !== this.data.data) {
        ...
        if ("all" === this.e) n.cssText = "", s = !0;else for (e = this.e.split(" ").join("").split(","), r = e.length; --r > -1;) {
          i = e[r], l[i] && (l[i].parse === a ? s = !0 : i = "transformOrigin" === i ? Pe : l[i].p), Ie(n, i);
        }
    ...
    }), h = "bezier,throwProps,physicsProps,physics2D".split(","), me = h.length; me--;) {
      ye(h[me]);
    }
    ...
    h = a.prototype, h._firstPT = h._lastParsedTransform = h._transform = null, h._onInitTween = function (t, e, o) {
      ...
      if (f && "" === T.zIndex && (l = G(t, "zIndex", s), ("auto" === l || "" === l) && this._addLazySet(T, "zIndex", 0)), "string" == typeof e && (d = T.cssText, l = K(t, s), T.cssText = d + ";" + e, l = J(t, l, K(t)).difs, !U && w.test(e) && (l.opacity = parseFloat(RegExp.$1)), e = l, T.cssText = d), this._firstPT = h = this.parse(t, e, null), this._transformType) {
        for (x = 3 === this._transformType, we ? p && (f = !0, "" === T.zIndex && (v = G(t, "zIndex", s), ("auto" === v || "" === v) && this._addLazySet(T, "zIndex", 0)), c && this._addLazySet(T, "WebkitBackfaceVisibility", this._vars.WebkitBackfaceVisibility || (x ? "visible" : "hidden"))) : T.zoom = 1, _ = h; _ && _._next;) {
          _ = _._next;
        }
    ...
    var Be = function Be(t, e, i) {
      var r, s, n, a;
      if (t.slice) for (s = t.length; --s > -1;) {
        Be(t[s], e, i);
      } else for (r = t.childNodes, s = r.length; --s > -1;) {
        n = r[s], a = n.type, n.style && (e.push(K(n)), i && i.push(n)), 1 !== a && 9 !== a && 11 !== a || !n.childNodes.length || Be(n, e, i);
      }
    };
    ...
    return a.cascadeTo = function (t, i, r) {
      ...
      for (t = o._targets || o.target, Be(t, h, f), o.render(i, !0), Be(t, u), o.render(0, !0), o._enabled(!0), s = f.length; --s > -1;) {
        if (n = J(f[s], h[s], u[s]), n.firstMPT) {
          n = n.difs;
...
(_gsScope._gsQueue || (_gsScope._gsQueue = [])).push(function () {
  ...
  _gsScope._gsDefine("TimelineMax", ["TimelineLite", "TweenLite", "easing.Ease"], function (t, e, i) {
    ...
    return _.constructor = s, _.kill()._gc = !1, s.version = "1.15.1", _.invalidate = function () {
      ...
      if (t >= p ? (this._locked || (this._totalTime = p, this._cycle = this._repeat), this._reversed || this._hasPausedChild() || (a = !0, _ = "onComplete", 0 === this._duration && (0 === t || 0 > y || y === r) && y !== t && this._first && (u = !0, y > r && (_ = "onReverseComplete"))), this._rawPrevTime = this._duration || !e || t || this._rawPrevTime === t ? t : r, this._yoyo && 0 !== (1 & this._cycle) ? this._time = t = 0 : (this._time = f, t = f + 1e-4)) : 1e-7 > t ? (this._locked || (this._totalTime = this._cycle = 0), this._time = 0, (0 !== m || 0 === f && y !== r && (y > 0 || 0 > t && y >= 0) && !this._locked) && (_ = "onReverseComplete", a = this._reversed), 0 > t ? (this._active = !1, y >= 0 && this._first && (u = !0), this._rawPrevTime = t) : (this._rawPrevTime = f || !e || t || this._rawPrevTime === t ? t : r, t = 0, this._initted || (u = !0))) : (0 === f && 0 > y && (u = !0), this._time = this._rawPrevTime = t, this._locked || (this._totalTime = t, 0 !== this._repeat && (c = f + this._repeatDelay, this._cycle = this._totalTime / c >> 0, 0 !== this._cycle && this._cycle === this._totalTime / c && this._cycle--, this._time = this._totalTime - this._cycle * c, this._yoyo && 0 !== (1 & this._cycle) && (this._time = f - this._time), this._time > f ? (this._time = f, t = f + 1e-4) : 0 > this._time ? this._time = t = 0 : t = this._time))), this._cycle !== w && !this._locked) {
        var b = this._yoyo && 0 !== (1 & w),
            ...
            k = this._rawPrevTime,
            C = this._time;
        if (this._totalTime = w * f, w > this._cycle ? b = !b : this._totalTime += f, this._time = m, this._rawPrevTime = 0 === f ? y - 1e-4 : y, this._cycle = w, this._locked = !0, m = b ? 0 : f, this.render(m, e, 0 === f), e || this._gc || this.vars.onRepeat && this.vars.onRepeat.apply(this.vars.onRepeatScope || this, this.vars.onRepeatParams || n), x && (m = b ? f + 1e-4 : -1e-4, this.render(m, !0, !1)), this._locked = !1, this._paused && !T) return;
    ...
    return s.version = "1.15.1", d.constructor = s, d.kill()._gc = d._forcingPlayhead = !1, d.to = function (t, e, s, r) {
      ...
      if (t >= c ? (this._totalTime = this._time = c, this._reversed || this._hasPausedChild() || (n = !0, o = "onComplete", 0 === this._duration && (0 === t || 0 > this._rawPrevTime || this._rawPrevTime === r) && this._rawPrevTime !== t && this._first && (h = !0, this._rawPrevTime > r && (o = "onReverseComplete"))), this._rawPrevTime = this._duration || !e || t || this._rawPrevTime === t ? t : r, t = c + 1e-4) : 1e-7 > t ? (this._totalTime = this._time = 0, (0 !== p || 0 === this._duration && this._rawPrevTime !== r && (this._rawPrevTime > 0 || 0 > t && this._rawPrevTime >= 0)) && (o = "onReverseComplete", n = this._reversed), 0 > t ? (this._active = !1, this._rawPrevTime >= 0 && this._first && (h = !0), this._rawPrevTime = t) : (this._rawPrevTime = this._duration || !e || t || this._rawPrevTime === t ? t : r, t = 0, this._initted || (h = !0))) : this._totalTime = this._time = this._rawPrevTime = t, this._time !== p && this._first || i || h) {
        if (this._initted || (this._initted = !0), this._active || !this._paused && this._time !== p && t > 0 && (this._active = !0), 0 === p && this.vars.onStart && 0 !== this._time && (e || this.vars.onStart.apply(this.vars.onStartScope || this, this.vars.onStartParams || u)), this._time >= p) for (s = this._first; s && (a = s._next, !this._paused || d);) {
          (s._active || s._startTime <= this._time && !s._paused && !s._gc) && (s._reversed ? s.render((s._dirty ? s.totalDuration() : s._totalDuration) - (t - s._startTime) * s._timeScale, e, i) : s.render((t - s._startTime) * s._timeScale, e, i)), s = a;
        } else for (s = this._last; s && (a = s._prev, !this._paused || d);) {
        ...
        this._onUpdate && (e || (l.length && _(), this._onUpdate.apply(this.vars.onUpdateScope || this, this.vars.onUpdateParams || u))), o && (this._gc || (f === this._startTime || m !== this._timeScale) && (0 === this._time || c >= this.totalDuration()) && (n && (l.length && _(), this._timeline.autoRemoveChildren && this._enabled(!1, !1), this._active = !1), !e && this.vars[o] && this.vars[o].apply(this.vars[o + "Scope"] || this, this.vars[o + "Params"] || u)));
      }
    }, d._hasPausedChild = function () {
      for (var t = this._first; t;) {
        if (t._paused || t instanceof s && t._hasPausedChild()) return !0;
...
(_gsScope._gsQueue || (_gsScope._gsQueue = [])).push(function () {
  ...
  _gsScope._gsDefine("plugins.CSSRulePlugin", ["plugins.TweenPlugin", "TweenLite", "plugins.CSSPlugin"], function (t, e, i) {
    var r = function r() {
      t.call(this, "cssRule"), this._overwriteProps.length = 0;
    },
        s = window.document,
        n = i.prototype.setRatio,
        a = r.prototype = new i();

    return a._propName = "cssRule", a.constructor = r, r.version = "0.6.3", r.API = 2, r.getRule = function (t) {
      var e,
          i,
          r,
          n,
          a = s.all ? "rules" : "cssRules",
          o = s.styleSheets,
          l = o.length,
          h = ":" === t.charAt(0);
      ...
      return n;
    }, a._onInitTween = function (t, e, r) {
      if (void 0 === t.cssText) return !1;
      var n = t._gsProxy = t._gsProxy || s.createElement("div");
      return this._ss = t, this._proxy = n.style, n.style.cssText = t.cssText, i.prototype._onInitTween.call(this, n, e, r), !0;
...
}("undefined" != typeof window ? window : void 0, function (e, n, t, o, i) {
  "use strict";
  ...
  e.fn.fullpage = function (N) {
    ...
    function Ie() {
      ...
      if (!N.autoScrolling || N.scrollBar) {
        ...
        if (r) a = s.length - 1;else if (o) for (var c = 0; c < s.length; ++c) {
          var d = s[c];
          d.offsetTop <= l && (a = c);
        } else a = 0;
    ...
    function an(n) {
      ...
      var t = e(":focus"),
          o = n.which;
      if (9 === o) vn(n);else if (!t.is("textarea") && !t.is("input") && !t.is("select") && "true" !== t.attr("contentEditable") && "" !== t.attr("contentEditable") && N.keyboardScrolling && N.autoScrolling) {
    ...
    function Fn(e) {
      if (N.recordHistory) location.hash = e;else if (pt || vt) n.history.replaceState(i, i, "#" + e);else {
